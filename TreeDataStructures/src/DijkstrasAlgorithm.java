...
public class DijkstrasAlgorithm {
  ...
  public DijkstrasAlgorithm(int n, Comparator<Node> comparator) {
    this(n);
  ...
  public double dijkstra(int start, int end) {
    ...
    while (!pq.isEmpty()) {
      ...
      // If we already find a better path before we get to
      // processing this node we can ignore it.
      if (dist[node.id] < node.value) {
    	  continue;
      }
      
      //Otherwise find neighbors
